...
class PizzaCamarao(Pizza):
    ...
    def servir(self, PizzaVeg):
        print(f" {type(self).__name__} é servida com camarão na pizza {type(PizzaVeg).__name__} ")
...
class PizzaBolonha(Pizza):
    ...
    def servir(self, PizzaVeg):
        print(f" {type(self).__name__} é servida com bolonha na pizza {type(PizzaVeg).__name__} ")
